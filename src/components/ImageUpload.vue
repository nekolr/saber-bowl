<template>
  <div class="content">
    ...
    :file-validate-type-label-expected-types="$t('upload.expectedTypes', {allTypes: '{allTypes}'})"
...
export default {
  ...
  methods: {
    ...
    // 处理图片选中的效果
    handleSelected(el) {
      var items = Array.prototype.filter.call(el.parentNode.children, function(child){
        return child !== el;
      })
